  ...
  class Character {
    ...
    */
    /*
      ...
      tandis que l'opérateur ' :: ' (aussi appelé Paamayim Nekudotayim) permet
      d'accéder directement aux membres d'une classe sans nécessité de l'instancier (ex: constantes).
    */
